...
def events_description(conversation_history,user_description: str):
    """
...
def send_question(conversation_history,) -> str:
...
def received_answer(conversation_history,user_answer: str):
    conversation_history.append({"role": "user", "content": user_answer})


def summary_event_description(conversation_history,) -> str:
